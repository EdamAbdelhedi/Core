...
extern uint8_t cut_pwm_a_switch_conv;
extern uint8_t cut_pwm_b_switch_conv;
extern uint8_t cut_pwm_c_switch_conv;
extern uint8_t cut_pwm_d_switch_conv;
extern uint8_t cut_pwm_e_switch_conv;
extern uint8_t cut_pwm_f_switch_conv;
