...
THINGSET_ADD_ITEM_UINT8 (ID_CUT_PWM_OUT, 0x7A46, "wASwitchConv", &cut_pwm_a_switch_conv, THINGSET_ANY_RW, SPIN_TS_NO_SUBSET);
...
THINGSET_ADD_ITEM_UINT8 (ID_CUT_PWM_OUT, 0x7A47, "wBSwitchConv", &cut_pwm_b_switch_conv, THINGSET_ANY_RW, SPIN_TS_NO_SUBSET);
...
THINGSET_ADD_ITEM_UINT8 (ID_CUT_PWM_OUT, 0x7A48, "wCSwitchConv", &cut_pwm_c_switch_conv, THINGSET_ANY_RW, SPIN_TS_NO_SUBSET);
...
THINGSET_ADD_ITEM_UINT8 (ID_CUT_PWM_OUT, 0x7A49, "wDSwitchConv", &cut_pwm_d_switch_conv, THINGSET_ANY_RW, SPIN_TS_NO_SUBSET);
...
THINGSET_ADD_ITEM_UINT8 (ID_CUT_PWM_OUT, 0x7A4A, "wESwitchConv", &cut_pwm_e_switch_conv, THINGSET_ANY_RW, SPIN_TS_NO_SUBSET);
...
THINGSET_ADD_ITEM_UINT8 (ID_CUT_PWM_OUT, 0x7A4B, "wFSwitchConv", &cut_pwm_f_switch_conv, THINGSET_ANY_RW, SPIN_TS_NO_SUBSET);
